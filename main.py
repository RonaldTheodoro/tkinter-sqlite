...
class Product:
    ...
    def adding(self):
        if self.validation():
            ...
            self.message['text'] = f'Record {self.name.get()} added'
    ...
    def deleting(self):
        ...
        self.message['text'] = f'Record {name} deleted'
        self.viewing_records()
    ...
    def editing(self):
        ...
        Label(self.edit_wind, text='New price').grid(row=2, column=1)
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = f'Record {name} changed'
        self.viewing_records()
